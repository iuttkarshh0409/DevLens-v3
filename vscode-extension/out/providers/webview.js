...
exports.DevLensReportPanel = void 0;
const vscode = __importStar(require("vscode"));
class DevLensReportPanel {
    static currentPanel;
    _panel;
    _disposables = [];
    static createOrShow(extensionUri, report) {
        ...
        const panel = vscode.window.createWebviewPanel('devlensReport', 'DevLens Audit Report', column || vscode.ViewColumn.One, {
            enableScripts: true,
...
exports.DevLensReportPanel = DevLensReportPanel;
